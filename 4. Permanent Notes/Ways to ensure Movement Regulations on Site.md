# **Ways to ensure Movement Regulations on Site**

**Tags**: #p-notes #construction-mangement #health-and-safety 
**Date Created: 2026-01-08:15:41**
____
To ensure [[Movement Regulations on Construction]], some technologies need to be employed and infrastructure need to be put in place. For example:
 - Entry and exit control (involves the introduction of security checkpoints at all access points)
